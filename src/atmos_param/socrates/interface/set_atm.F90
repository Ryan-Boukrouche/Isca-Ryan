...
USE socrates_config_mod, only: co_mix_ratio, n2o_mix_ratio, ch4_mix_ratio, o2_mix_ratio, so2_mix_ratio, h2_mix_ratio, n2_mix_ratio, nh3_mix_ratio, he_mix_ratio, cfc11_mix_ratio, cfc12_mix_ratio, cfc113_mix_ratio, hcfc22_mix_ratio, hfc134a_mix_ratio
USE gas_list_pcf, ONLY: ip_h2o, ip_co2, ip_o3, ip_n2o, ip_ch4, ip_o2, ip_so2, ip_h2, ip_n2, ip_nh3, ip_he, &
...
DO i_gas=1, spectrum%gas%n_absorb
  ...
  CASE(ip_nh3)
    DO i=1, n_layer
      DO l=1, n_profile
        atm%gas_mix_ratio(l, i, i_gas) = nh3_mix_ratio
      END DO
    END DO   
  ...
  CASE(ip_he)
    DO i=1, n_layer
      DO l=1, n_profile
        atm%gas_mix_ratio(l, i, i_gas) = he_mix_ratio
      END DO
    END DO   
