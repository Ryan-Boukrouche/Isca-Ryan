...
omega = planets[planet]['Angular velocity']*2 # planet rotates twice around itself during one 5-day orbit.
# Orbital period [s]
...
exp = Experiment('planetb_ArcheanEarth_rot_half', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        ...
        'valid_range_t':[100.,800.], #[1.,800.], #[20.,2000.]
        'initial_sphum':[2.e-6],
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca_outputs/planetb_ArcheanEarth_rot_half/run0782/res0782/*'
        exp.run(782, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(783,7200): # 60 years + 1 year: to 720, then to 732
