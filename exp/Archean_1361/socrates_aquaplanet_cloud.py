...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/lockedEarth_ArcheanEarth_rot0/run0162/res0162/*'
        exp.run(162, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(163,720): # 60 years + 1 year: to 720, then to 732
