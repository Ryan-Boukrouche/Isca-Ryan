...
exp = Experiment('planetb_presentdayEarth_rot0_1420_noO3', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/planetb_presentdayEarth_rot0_1420_noO3/run0075/res0075/*'

        exp.run(75, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(76,7200): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
