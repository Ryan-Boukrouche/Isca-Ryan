...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca_outputs/Earth/runh0731/resh0731/*'
        exp.run(731, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(732,931): # 61 years+200 hours
