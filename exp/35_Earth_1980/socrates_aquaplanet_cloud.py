...
exp = Experiment('Earth_1980', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Earth_1980/run0022/res0022/*'
        exp.run(23, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(24,301): # 25 years + 1 month
