...
exp = Experiment('6_1400_as007_default', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/6_1400_as007_default/run0014/res0014/*'

        exp.run(15, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(16,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
