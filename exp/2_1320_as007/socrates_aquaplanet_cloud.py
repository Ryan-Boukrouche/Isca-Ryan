...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/2_1320_as007/run0019/res0019/*'

        exp.run(20, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(21,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
