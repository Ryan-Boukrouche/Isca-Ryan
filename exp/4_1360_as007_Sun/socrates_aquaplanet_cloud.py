...
exp = Experiment('4_1360_as007_Sun', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/4_1360_as007_Sun/run0059/res0059/*'

        exp.run(60, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(61,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
