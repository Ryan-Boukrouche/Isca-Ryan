...
exp = Experiment('6_1400_as007_crashed', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/6_1400_as007_crashed/run0140/res0140/*'

        exp.run(141, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)
