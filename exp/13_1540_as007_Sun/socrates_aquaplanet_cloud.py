...
exp = Experiment('13_1540_as007_Sun', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/13_1540_as007_Sun/run0095/res0095/*'

        exp.run(96, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(97,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
