...
exp = Experiment('planetb_presentdayEarth_rot_half', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca_outputs/planetb_presentdayEarth_rot_half/run0026/res0026/*'

        exp.run(0, use_restart='', num_cores=NCORES, overwrite_data=overwrite)

        for i in range(1,720): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
