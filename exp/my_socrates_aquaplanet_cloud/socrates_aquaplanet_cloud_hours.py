...
exp.namelist = namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {
        ...
        'do_lcl_diffusivity_depth': True # non-local K scheme, if do_diffusivity = True in vert_turb_driver_nml
    },
    ...
    'spectral_dynamics_nml': {
        ...
        'valid_range_t':[90.,800.], #[100.,800.], #[20.,2000.]
        'initial_sphum':[2.e-6],
...
if __name__=="__main__":
        ...
        #restart_files = '/proj/bolinc/users/x_ryabo/Isca_outputs/planetb_presentdayEarth_rot0/run0089/res0089/*'
        #restart_files = '/proj/bolinc/users/x_ryabo/Isca_outputs/planetb_presentdayEarth_rot0/run0088/res0088/*'
        restart_files = '/proj/bolinc/users/x_ryabo/Isca_outputs/planetb_presentdayEarth_rot0/run0155/res0155/*'

        exp.run(155, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(155,3000): # 60 years + 1 year: to 720, then to 732
