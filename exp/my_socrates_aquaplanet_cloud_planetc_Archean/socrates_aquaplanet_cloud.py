...
exp = Experiment('planetc_ArcheanEarth_rot0', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'mixed_layer_nml': {
        'tconst' : 500.0, #310., #285. The Archean should've had at most 313.15K/40C, though of course it will change with tidal locking.
    ...
    'spectral_dynamics_nml': {
        ...
        'valid_range_t':[60.,800.], #[1.,800.], #[20.,2000.]
        'initial_sphum':[2.e-6],
...
if __name__=="__main__":
        ...
        #restart_files = '/proj/bolinc/users/x_ryabo/Isca_outputs/planetc_ArcheanEarth_rot0/run0007/res0007/*'
