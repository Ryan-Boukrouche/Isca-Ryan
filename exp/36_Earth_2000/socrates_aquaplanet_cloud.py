...
exp = Experiment('Earth_2000', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Earth_2000/run0024/res0024/*'
        exp.run(25, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(26,301): # 25 years + 1 month
