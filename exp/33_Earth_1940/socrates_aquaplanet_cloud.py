...
exp = Experiment('Earth_1940', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'damping_driver_nml': {
        ...
        'sponge_pbottom':  150.0*(p_surf/1e5), #20., #Setting the lower pressure boundary for the model sponge layer in Pa.
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Earth_1940/run0032/res0032/*'
        exp.run(33, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(34,301): # 25 years + 1 month
