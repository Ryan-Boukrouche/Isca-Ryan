...
exp = Experiment('6_1400_as007_Sun_default', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/6_1400_as007_Sun_default/run0271/res0271/*'

        exp.run(272, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(273,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
