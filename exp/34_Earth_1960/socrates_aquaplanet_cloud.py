...
exp = Experiment('Earth_1960', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Earth_1960/run0027/res0027/*'
        exp.run(28, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(29,301): # 25 years + 1 month
