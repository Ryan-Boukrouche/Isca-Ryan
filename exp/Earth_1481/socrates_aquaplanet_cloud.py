...
exp = Experiment('Earth_1481', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Earth_1481/run0095/res0095/*'
        exp.run(95, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(96,1001): # 60+1 years (range(721,732) at the end)
