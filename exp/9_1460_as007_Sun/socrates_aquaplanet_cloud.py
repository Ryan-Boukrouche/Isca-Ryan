...
exp = Experiment('9_1460_as007_Sun', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/9_1460_as007_Sun/run0097/res0097/*'

        exp.run(98, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(99,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
