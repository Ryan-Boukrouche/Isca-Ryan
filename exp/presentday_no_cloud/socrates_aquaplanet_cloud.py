...
exp = Experiment('planetb_presentdayEarth_rot0_no_cloud', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/planetb_presentdayEarth_rot0_no_cloud/run0012/res0012/*'

        exp.run(12, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(13,7200): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
