...
exp.namelist = namelist = Namelist({
    ...
    'spectral_dynamics_nml': {
        ...
        'valid_range_t':[60.,800.],#[100.,800.], #[20.,2000.]
        'initial_sphum':[2.e-6],
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/planetb_EoceneEarth_rot0/run0116/res0116/*'
        exp.run(116, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(117,721): # 60 years + 1 year: to 720, then to 732
