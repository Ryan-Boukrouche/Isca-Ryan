...
exp = Experiment('planetc_presentdayEarth_rot0', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        #restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/planetc_presentdayEarth_rot0/run0386/res0386/*'
