...
exp = Experiment('12_1520_as007', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/12_1520_as007/run0028/res0028/*'

        exp.run(29, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(30,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
