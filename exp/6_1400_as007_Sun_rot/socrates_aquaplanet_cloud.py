...
exp = Experiment('6_1400_as007_Sun_rot', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':"/proj/bolinc/users/x_ryabo/socrates_edited_for_isca/spectral_files_for_GCMs/Sun/miniSuran_lw.sf",
        'sw_spectral_filename':"/proj/bolinc/users/x_ryabo/socrates_edited_for_isca/spectral_files_for_GCMs/Sun/miniSuran_sw.sf",
        'do_read_ozone': True,
...
if __name__=="__main__":
        ...
        for i in range(1,502): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
