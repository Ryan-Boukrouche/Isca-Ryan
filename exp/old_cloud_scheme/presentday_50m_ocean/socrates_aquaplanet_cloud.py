...
exp = Experiment('planetb_presentdayEarth_rot0_50m_ocean', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'mixed_layer_nml': {
        ...
        'evaporation':True,  
        'depth': 50.0,#2.5,                          #Depth of mixed layer used
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/planetb_presentdayEarth_rot0_50m_ocean/run0450/res0450/*'

        exp.run(450, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(451,7200): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
