...
exp = Experiment('presentday_1481_nocloud', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/presentday_1481_nocloud/run0499/res0499/*'

        exp.run(499, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(500,501): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
