...
exp = Experiment('1_1400_as03', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/1_1400_as03/run0090/res0090/*'

        exp.run(90, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(91,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
