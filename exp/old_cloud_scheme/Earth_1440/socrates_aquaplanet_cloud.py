...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Earth_1440/run0259/res0259/*'
        exp.run(259, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(260,1001): # 60+1 years (range(721,732) at the end)
