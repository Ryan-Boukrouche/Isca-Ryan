...
exp = Experiment('6_1520_as007', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        #restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/6_1520_as007/run0013/res0013/*'

        exp.run(0, use_restart='', num_cores=NCORES, overwrite_data=overwrite)

        for i in range(1,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
