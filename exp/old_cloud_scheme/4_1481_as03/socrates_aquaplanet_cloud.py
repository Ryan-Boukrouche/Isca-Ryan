...
exp = Experiment('4_1481_as03', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/4_1481_as03/run0304/res0304/*'

        exp.run(305, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        #for i in range(305,305): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
