...
exp = Experiment('10_1600_as03', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/10_1600_as03/run0023/res0023/*'

        exp.run(23, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(24,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
