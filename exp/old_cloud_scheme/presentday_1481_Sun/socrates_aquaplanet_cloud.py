...
exp = Experiment('presentday_1481_Sun', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/presentday_1481_Sun/run0498/res0498/*'

        exp.run(498, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(499,500): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
