...
exp = Experiment('presentday_1580_Sun_noO3', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        #restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/presentday_1580_Sun_noO3/run0700/res0700/*'

        exp.run(0, use_restart='', num_cores=NCORES, overwrite_data=overwrite)

        for i in range(1,1001): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
