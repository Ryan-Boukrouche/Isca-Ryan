...
exp = Experiment('presentday_1400_Sun_noO3', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/presentday_1400_Sun_noO3/run0008/res0008/*'

        exp.run(8, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(9,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
