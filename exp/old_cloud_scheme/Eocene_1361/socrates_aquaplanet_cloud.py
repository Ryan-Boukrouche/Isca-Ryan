...
exp = Experiment('Eocene_1361', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Eocene_1361/run0021/res0021/*'
        exp.run(21, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(22,499): # 60 years + 1 year: to 720, then to 732
