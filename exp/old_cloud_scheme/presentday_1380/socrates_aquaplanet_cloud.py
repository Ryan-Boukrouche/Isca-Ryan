...
exp = Experiment('planetb_presentdayEarth_rot0_1380', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/planetb_presentdayEarth_rot0_1380/run0184/res0184/*'

        exp.run(184, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(185,7200): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
