...
exp = Experiment('Eocene_1565', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Eocene_1565/run0043/res0043/*'
        exp.run(43, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(44,499): # 60 years + 1 year: to 720, then to 732
