...
exp = Experiment('Eocene_1345', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Eocene_1345/run0026/res0026/*'
        exp.run(26, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(27,499): # 60 years + 1 year: to 720, then to 732
