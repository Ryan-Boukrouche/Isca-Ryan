...
exp = Experiment('7_1540_as03', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/7_1540_as03/run0119/res0119/*'

        exp.run(119, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(120,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
