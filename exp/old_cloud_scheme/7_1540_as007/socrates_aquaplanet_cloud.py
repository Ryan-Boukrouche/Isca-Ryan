...
exp = Experiment('7_1540_as007', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/7_1540_as007/run0009/res0009/*'

        exp.run(9, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(10,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
