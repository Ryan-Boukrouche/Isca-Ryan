...
exp = Experiment('4_1481_as007', codebase=cb)
exp.clear_rundir()
...
exp.namelist = namelist = Namelist({
    ...
    'socrates_rad_nml': {
        ...
        'lw_spectral_filename':"/proj/bolinc/users/x_ryabo/socrates_edited_for_isca/spectral_files_for_GCMs/Teegarden/Suran_lw.sf",
        'sw_spectral_filename':"/proj/bolinc/users/x_ryabo/socrates_edited_for_isca/spectral_files_for_GCMs/Teegarden/Suran_sw.sf",
        'do_read_ozone': True,
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/presentday_1481_noO3/run0473/res0473/*'

        exp.run(474, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        #for i in range(474,474): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
