...
exp = Experiment('14_1560_as007_Sun', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/14_1560_as007_Sun/run0114/res0114/*'

        exp.run(115, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(116,499): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
