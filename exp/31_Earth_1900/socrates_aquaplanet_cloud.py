...
exp = Experiment('Earth_1900', codebase=cb)
exp.clear_rundir()
...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/Earth_1900/run0040/res0040/*'
        exp.run(41, use_restart=restart_files, num_cores=NCORES, overwrite_data=overwrite)

        for i in range(42,301): # 25 years + 1 month
