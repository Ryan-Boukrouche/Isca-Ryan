...
if __name__=="__main__":
        ...
        restart_files = '/proj/bolinc/users/x_ryabo/Isca-Ryan_outputs/lockedEarth_presentdayEarth_rot0/run0260/res0260/*'

        exp.run(260, use_restart='', num_cores=NCORES, overwrite_data=overwrite)

        for i in range(261,273): # 60 years + 1 year: to 720 with 16 bands, then to 732 with 400 bands
